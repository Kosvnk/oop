public class Main {
    ...
    */
	public static void main(String[] args) {
        ...
        final short bookNumber = 0x3A3B;
        final long phoneNumber = 380506015527L;
        final byte binaryPhoneOfNumber = 0b11011;
        final short octalPhoneOfNumber = 012627;
        final byte numberInJournal = 8;
